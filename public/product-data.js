...
Object.assign(GYUTRON_PRODUCTS, {
    ...
    "cobot-inspection-cells": {
        eyebrow: "Robot Workcells",
        title: "Cobot Inspection Cells",
        navLabel: "Cobot Inspection Cells",
        navGroup: "robot",
        heroImage: "product-vision-cell.png",
        intro: "Collaborative robot inspection cells that combine robot motion, machine vision, safety, and traceability for repeatable line-side checks.",
        panelMetric: "2 cells",
        panelText: "Camera-guided inspection stations for assembly verification and pass/fail handling.",
        sectionIntro: "This category follows the common industry split between inspection, tending, and material-handling workcells. These cells are positioned as configurable stations rather than standalone robots.",
        products: [
            {
                name: "GY-RC20 Vision Cell",
                type: "Cobot inspection cell",
                summary: "Compact collaborative inspection station for part presence, orientation checks, code reading, and reject confirmation.",
                kind: "instrument",
                image: "product-vision-cell.png",
                specs: { Payload: "5 kg class", Vision: "2D smart camera", Safety: "Scanner + interlock", Footprint: "1200 x 900 mm" },
                tags: ["Inspection", "Traceability", "Compact cell"]
            },
            {
                name: "GY-RC35 Inline QC Cell",
                type: "Inline robot QC station",
                summary: "Flexible QC station for pick-inspect-place workflows, dimensional checks, and controlled reject routing.",
                kind: "instrument",
                image: "hero-industrial-automation.png",
                specs: { Payload: "7 kg class", Reach: "850 mm class", Vision: "Camera + lighting", Interface: "Ethernet / discrete IO" },
                tags: ["Inline QC", "Pick inspect place", "Ethernet"]
            }
        ]
    },
    "machine-tending-cells": {
        eyebrow: "Robot Workcells",
        title: "Machine Tending Cells",
        navLabel: "Machine Tending Cells",
        navGroup: "robot",
        heroImage: "hero-industrial-automation.png",
        intro: "Pre-engineered tending stations for loading, unloading, scan confirmation, and fixture handoff around CNC, press, and test equipment.",
        panelMetric: "2 cells",
        panelText: "Compact and dual-machine tending options for repetitive loading workflows.",
        sectionIntro: "Machine tending is separated from inspection because buyers evaluate gripper, reach, guarding, machine interface, and repeatability differently from pure QC applications.",
        products: [
            {
                name: "GY-MT25 Compact Tending",
                type: "Compact tending cell",
                summary: "Small-footprint robot tending package for single-machine loading, unloading, scan confirmation, and fixture presentation.",
                kind: "instrument",
                image: "contact-sales-hero.png",
                specs: { Payload: "8 kg class", Interface: "Door / cycle IO", Gripper: "Electric or pneumatic", Safety: "Light curtain option" },
                tags: ["Machine tending", "Single machine", "Fixture handoff"]
            },
            {
                name: "GY-MT40 Dual Station",
                type: "Dual-machine tending cell",
                summary: "Expanded tending platform for two adjacent machines, with queue trays, part verification, and production status outputs.",
                kind: "instrument",
                image: "cta-industrial-control.png",
                specs: { Payload: "12 kg class", Reach: "1300 mm class", Queue: "Tray / conveyor", Data: "Cycle count + status" },
                tags: ["Dual station", "Queue tray", "Production status"]
            }
        ]
    },
    "palletizing-sorting-cells": {
        eyebrow: "Robot Workcells",
        title: "Palletizing & Sorting Cells",
        navLabel: "Palletizing & Sorting",
        navGroup: "robot",
        heroImage: "cta-industrial-control.png",
        intro: "Light palletizing, carton sorting, and package handling cells for end-of-line automation where flexible deployment matters more than maximum payload.",
        panelMetric: "2 cells",
        panelText: "End-of-line palletizing and vision-assisted sorting configurations.",
        sectionIntro: "These workcells are grouped around material flow rather than inspection, with practical emphasis on reach, conveyor coordination, case handling, and changeover.",
        products: [
            {
                name: "GY-PL60 Light Palletizer",
                type: "Collaborative palletizing cell",
                summary: "Light-duty palletizing cell for cartons, totes, and mixed SKU patterns with simple recipe changeover.",
                kind: "instrument",
                image: "product-intelligent-hardware.png",
                specs: { Payload: "10 kg class", Height: "1700 mm stack", Patterns: "Recipe-based", Safety: "Collaborative zone" },
                tags: ["Palletizing", "Recipe changeover", "End-of-line"]
            },
            {
                name: "GY-SRT30 Vision Sort Cell",
                type: "Vision sorting cell",
                summary: "Camera-guided sorting station for package routing, label verification, and reject diversion in compact conveyor layouts.",
                kind: "instrument",
                image: "mega-industrial-products.png",
                specs: { Throughput: "Up to 30 picks/min", Vision: "Code + presence", Conveyor: "Belt / roller", Output: "PLC status" },
                tags: ["Sorting", "Label check", "Conveyor cell"]
            }
        ]
    },
    "edge-ai-controllers": {
        eyebrow: "Edge Controllers",
        title: "Edge AI Controllers",
        navLabel: "Edge AI Controllers",
        navGroup: "edge",
        heroImage: "product-hero-smart-vision-sensors-matrix.png",
        intro: "Fanless industrial edge computers for vision inference, device orchestration, local dashboards, and production data buffering.",
        panelMetric: "3 models",
        panelText: "Compact AI, multi-camera, and rugged edge compute options.",
        sectionIntro: "Edge AI controllers are separated from gateways because they run heavier local workloads such as image inference, recipe handling, and multi-device coordination.",
        products: [
            {
                name: "GY-EC4",
                type: "Compact edge AI controller",
                summary: "Fanless edge controller for one to four vision devices, local inference, recipe storage, and station-level dashboards.",
                kind: "instrument",
                image: "product-images/gy-vc8.png",
                specs: { CPU: "Industrial quad-core", AI: "8 TOPS class", Cameras: "Up to 4 devices", Temp: "-10 C to 55 C" },
                tags: ["Edge AI", "Fanless", "Vision cell"]
            },
            {
                name: "GY-EC8",
                type: "Multi-camera edge computer",
                summary: "Higher-capacity edge computer for multi-camera inspection cells, buffering, analytics, and PLC data exchange.",
                kind: "instrument",
                image: "product-images/gy-net8.png",
                specs: { CPU: "8-core industrial", AI: "20 TOPS option", Storage: "Dual SSD option", Network: "2.5 GbE" },
                tags: ["Multi-camera", "Analytics", "2.5 GbE"]
            },
            {
                name: "GY-EC12 Pro",
                type: "Rugged production edge controller",
                summary: "Rugged controller for higher-load production cells that need local compute, historian buffering, and remote service access.",
                kind: "instrument",
                image: "product-images/gy-vfg4.png",
                specs: { CPU: "12-core class", I_O: "Isolated DI / DO", Security: "TPM option", Mount: "DIN / panel" },
                tags: ["Production edge", "Historian buffer", "Remote service"]
            }
        ]
    },
    "industrial-iot-gateways": {
        ...
        navLabel: "Industrial IoT Gateways",
        navGroup: "edge",
        heroImage: "product-hero-environmental-sensing-matrix.png",
        intro: "Industrial gateways for IO-Link, Modbus, Ethernet/IP, MQTT, cellular backhaul, and connected machine monitoring.",
        panelMetric: "2 models",
        panelText: "Protocol and cellular gateway options for connected operations.",
        sectionIntro: "Gateways focus on protocol translation, device onboarding, and data movement. They stay separate from edge AI controllers because the buying criteria are connectivity, security, and uptime.",
        products: [
            {
                name: "GY-GW24",
                type: "Protocol gateway",
                summary: "Industrial protocol gateway for bridging sensors, PLCs, and edge dashboards across common factory networks.",
                kind: "instrument",
                image: "product-images/gy-net8.png",
                specs: { Protocols: "Modbus / MQTT / Ethernet-IP", Ports: "2x Ethernet", Power: "24 VDC", Mount: "DIN rail" },
                tags: ["Gateway", "MQTT", "DIN rail"]
            },
            {
                name: "GY-GW5G",
                type: "Cellular industrial gateway",
                summary: "Cellular gateway for remote assets, field service systems, and temporary production lines requiring secure connectivity.",
                kind: "instrument",
                image: "product-images/gy-env32.png",
                specs: { Cellular: "5G / LTE option", VPN: "Client support", GNSS: "Optional", Temp: "-20 C to 60 C" },
                tags: ["5G", "Remote assets", "Secure access"]
            }
        ]
    },
    "vision-io-controllers": {
        eyebrow: "Edge Controllers",
        title: "Vision & I/O Controllers",
        navLabel: "Vision & I/O Controllers",
        navGroup: "edge",
        heroImage: "product-hero-code-reading-cameras-matrix.png",
        intro: "Timing, trigger, lighting, and I/O controllers for inspection stations that need deterministic device coordination.",
        panelMetric: "2 models",
        panelText: "Trigger control and station I/O modules for machine vision cells.",
        sectionIntro: "This category supports the control layer around cameras and readers: trigger timing, lighting control, discrete outputs, and cell-level handshakes.",
        products: [
            {
                name: "GY-VIO8",
                type: "Vision I/O controller",
                summary: "Compact timing and I/O controller for camera triggering, reject outputs, encoder input, and inspection status exchange.",
                kind: "instrument",
                image: "product-images/gy-vio16.png",
                specs: { Inputs: "8 isolated inputs", Outputs: "8 isolated outputs", Trigger: "Encoder / sensor", Mount: "DIN rail" },
                tags: ["Trigger", "I/O", "Vision cell"]
            },
            {
                name: "GY-TRG4",
                type: "Lighting trigger controller",
                summary: "Four-channel timing controller for synchronized cameras, white-light strobes, sensors, and conveyor encoders.",
                kind: "instrument",
                image: "product-images/gy-lc4.png",
                specs: { Channels: "4 trigger channels", Timing: "Microsecond class", Lighting: "White strobe control", Interface: "Ethernet / IO" },
                tags: ["Timing", "Lighting trigger", "Encoder"]
            }
        ]
    },
    "pda-docks-power": {
        eyebrow: "Accessories",
        title: "PDA Docks & Power",
        navLabel: "PDA Docks & Power",
        navGroup: "accessories",
        heroImage: "product-hero-android-pda-matrix.png",
        intro: "Charging, docking, vehicle power, and spare battery accessories for rugged handheld deployments.",
        panelMetric: "3 accessories",
        panelText: "Desktop, multi-slot, battery, and vehicle power options.",
        sectionIntro: "PDA power accessories are grouped separately because operations teams usually buy them by shift model, charging policy, and device fleet size.",
        products: [
            {
                name: "GY-DK6",
                type: "Six-slot charging dock",
                summary: "Fleet charging dock for handheld terminals with guided slots, status indicators, and replaceable power module.",
                kind: "instrument",
                image: "product-images/gy-s680-dock.png",
                specs: { Slots: "6 devices", Power: "120 W adapter", Status: "Per-slot LED", Mount: "Desk / shelf" },
                tags: ["Dock", "Fleet charging", "PDA"]
            },
            {
                name: "GY-BAT68",
                type: "High-capacity battery pack",
                summary: "Spare rugged battery pack for extended warehouse shifts, field service work, and cold-chain deployments.",
                kind: "instrument",
                image: "product-images/gy-a70-cold.png",
                specs: { Capacity: "6800 mAh class", Cycle: "500+ cycles", Lock: "Tool-less latch", Use: "A-series PDA" },
                tags: ["Battery", "Shift work", "Spare pack"]
            },
            {
                name: "GY-CHG4V",
                type: "Vehicle charging kit",
                summary: "Vehicle cradle and charger kit for forklifts, service vans, carts, and mobile workstations.",
                kind: "instrument",
                image: "product-images/gy-s330-cold.png",
                specs: { Input: "9-36 VDC", Output: "Fast-charge PDA", Mount: "RAM-compatible", Cable: "Locking connector" },
                tags: ["Vehicle", "Cradle", "Mobile power"]
            }
        ]
    },
    "vision-lenses-mounts": {
        eyebrow: "Accessories",
        title: "Vision Lenses & Mounts",
        navLabel: "Vision Lenses & Mounts",
        navGroup: "accessories",
        heroImage: "product-hero-area-scan-cameras-matrix.png",
        intro: "Optics, mounting hardware, protective windows, and alignment parts for industrial camera installations.",
        panelMetric: "3 accessories",
        panelText: "C-mount optics, telecentric optics, and rigid mounting hardware.",
        sectionIntro: "Vision accessories are kept apart from camera products so engineers can specify the optical chain, mounting, and service parts without creating duplicate camera models.",
        products: [
            {
                name: "GY-LENS16",
                type: "C-mount lens kit",
                summary: "Industrial C-mount lens kit for common working distances, field-of-view trials, and machine vision setup work.",
                kind: "instrument",
                image: "product-images/gy-opt25.png",
                specs: { Focal: "8 / 12 / 16 mm options", Mount: "C-mount", Iris: "Manual lock", Use: "2D cameras" },
                tags: ["Lens", "C-mount", "Vision setup"]
            },
            {
                name: "GY-OPT-M25",
                type: "Telecentric optics module",
                summary: "Telecentric optics module for dimensional inspection cells where low distortion and stable measurement scale matter.",
                kind: "instrument",
                image: "product-images/gy-opt25.png",
                specs: { Magnification: "0.25x class", Mount: "C-mount", Distortion: "Low distortion", Use: "Metrology" },
                tags: ["Telecentric", "Metrology", "Low distortion"]
            },
            {
                name: "GY-MNT-RIGID",
                type: "Rigid camera mount",
                summary: "Adjustable industrial camera mount with locking joints, cable relief, and vibration-resistant fixture hardware.",
                kind: "instrument",
                image: "product-images/gy-v120.png",
                specs: { Material: "Anodized aluminum", Adjustment: "XYZ + angle", Locking: "Dual clamp", Mount: "T-slot / plate" },
                tags: ["Mount", "Fixture", "Camera setup"]
            }
        ]
    },
    "sensor-cables-brackets": {
        eyebrow: "Accessories",
        title: "Sensor Cables & Brackets",
        navLabel: "Sensor Cables & Brackets",
        navGroup: "accessories",
        heroImage: "product-hero-proximity-sensors-matrix.png",
        intro: "Industrial cables, mounting brackets, junction boxes, and adapter parts for sensor and I/O deployments.",
        panelMetric: "3 accessories",
        panelText: "M12 cable sets, brackets, and junction hardware for sensors.",
        sectionIntro: "Sensor accessories are practical deployment items. They are grouped by installation hardware rather than by sensing principle.",
        products: [
            {
                name: "GY-CBL-M12",
                type: "M12 cable set",
                summary: "Shielded industrial M12 cable set for sensors, IO-Link devices, machine vision triggers, and cabinet routing.",
                kind: "instrument",
                image: "product-images/gy-net8.png",
                specs: { Connector: "M12 A-coded", Lengths: "2 / 5 / 10 m", Jacket: "PUR", Rating: "IP67 class" },
                tags: ["M12", "Cable", "IP67"]
            },
            {
                name: "GY-BRK-SEN",
                type: "Sensor bracket kit",
                summary: "Bracket assortment for round, rectangular, and photoelectric sensors on conveyors, fixtures, and guarding frames.",
                kind: "instrument",
                image: "product-images/gy-px18.png",
                specs: { Material: "Stainless / aluminum", Mount: "T-slot / plate", Sizes: "M8 to M30", Adjust: "Slotted" },
                tags: ["Bracket", "Sensor mount", "Conveyor"]
            },
            {
                name: "GY-JBX8",
                type: "Eight-port junction box",
                summary: "Passive sensor junction box for consolidating discrete sensors and simplifying line-side wiring.",
                kind: "instrument",
                image: "product-images/gy-net8.png",
                specs: { Ports: "8x M12", Output: "M23 / cable tail", Rating: "IP67", Labels: "Numbered ports" },
                tags: ["Junction box", "Sensor wiring", "Line-side"]
            }
        ]
    },
    "rfid-barcode-accessories": {
        eyebrow: "Accessories",
        title: "RFID & Barcode Accessories",
        navLabel: "RFID & Barcode Accessories",
        navGroup: "accessories",
        heroImage: "product-hero-barcode-scanners-matrix.png",
        intro: "Handles, grips, holsters, labels, screen protection, and service parts for scan and RFID workflows.",
        panelMetric: "4 accessories",
        panelText: "Grip, holster, label, and protection accessories for data-capture deployments.",
        sectionIntro: "Data-capture accessories are grouped by workflow support: ergonomics, protection, label media, and field replacement.",
        products: [
            {
                name: "GY-GRIP-RFID",
                type: "RFID pistol grip",
                summary: "Trigger grip accessory for RFID handhelds, supporting longer scan sessions and warehouse cycle counts.",
                kind: "instrument",
                image: "product-images/gy-r60-grip.png",
                specs: { Fit: "R-series handhelds", Trigger: "Integrated", Battery: "Optional booster", Use: "Inventory" },
                tags: ["RFID", "Grip", "Cycle count"]
            },
            {
                name: "GY-TRG-SCAN",
                type: "Scanner trigger handle",
                summary: "Clip-on scan handle for PDA terminals used in receiving, picking, dispatch, and line-side confirmation.",
                kind: "instrument",
                image: "product-images/gy-s300-dpm.png",
                specs: { Fit: "A / S series", Trigger: "Mechanical", Strap: "Included", Use: "High-volume scanning" },
                tags: ["Scanner", "Handle", "Warehouse"]
            },
            {
                name: "GY-HOL-RUG",
                type: "Rugged holster",
                summary: "Belt and cart holster for protecting handheld scanners and terminals during shift work.",
                kind: "instrument",
                image: "product-images/gy-a50.png",
                specs: { Material: "Reinforced polymer", Carry: "Belt / cart", Drain: "Open base", Use: "PDA / scanner" },
                tags: ["Holster", "Protection", "Shift work"]
            },
            {
                name: "GY-LBL-RFID",
                type: "RFID label starter pack",
                summary: "Starter pack of sample RFID labels for read-range trials, tag placement validation, and pilot deployments.",
                kind: "instrument",
                image: "product-images/gy-conf-rfid.png",
                specs: { Tags: "Mixed sample set", Frequency: "UHF", Labels: "On-metal option", Use: "Pilot trials" },
                tags: ["RFID labels", "Pilot", "Tag validation"]
            }
        ]
    }
});
...
const CATEGORY_GROUPS = {
    ...
    "robot": ["cobot-inspection-cells", "machine-tending-cells", "palletizing-sorting-cells"],
    "edge": ["edge-ai-controllers", "industrial-iot-gateways", "vision-io-controllers"],
    "accessories": ["pda-docks-power", "vision-lenses-mounts", "sensor-cables-brackets", "rfid-barcode-accessories"]
};
