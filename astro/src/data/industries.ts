    ...
    sections: [
      {
        ...
        cards: [
          { titleKey: 'iep.line.s1.t', descKey: 'iep.line.s1.d' },
          { titleKey: 'iep.line.s2.t', descKey: 'iep.line.s2.d' },
          { titleKey: 'iep.line.s3.t', descKey: 'iep.line.s3.d' },
          { titleKey: 'iep.line.s4.t', descKey: 'iep.line.s4.d' },
          { titleKey: 'iep.line.s5.t', descKey: 'iep.line.s5.d' },
          { titleKey: 'iep.line.s6.t', descKey: 'iep.line.s6.d' },
          { titleKey: 'iep.line.s7.t', descKey: 'iep.line.s7.d' },
        ],
      },
      {
        id: 'segments', kind: 'capability', eyebrowKey: 'iep.seg.eyebrow', titleKey: 'iep.seg.title', introKey: 'iep.seg.intro',
        cards: [
          { titleKey: 'iep.seg.c1.t', descKey: 'iep.seg.c1.d' },
          { titleKey: 'iep.seg.c2.t', descKey: 'iep.seg.c2.d' },
          { titleKey: 'iep.seg.c3.t', descKey: 'iep.seg.c3.d' },
          { titleKey: 'iep.seg.c4.t', descKey: 'iep.seg.c4.d' },
        ],
      },
      {
      ...
      },
      {
        ...
        cards: [
          { titleKey: 'iep.insp.c1.t', descKey: 'iep.insp.c1.d' },
          { titleKey: 'iep.insp.c2.t', descKey: 'iep.insp.c2.d' },
          { titleKey: 'iep.insp.c3.t', descKey: 'iep.insp.c3.d' },
          { titleKey: 'iep.insp.c4.t', descKey: 'iep.insp.c4.d' },
          { titleKey: 'iep.insp.c5.t', descKey: 'iep.insp.c5.d' },
          { titleKey: 'iep.insp.c6.t', descKey: 'iep.insp.c6.d' },
        ],
      },
      {
        id: 'why', variant: 'dark', kind: 'capability', eyebrowKey: 'iep.why.eyebrow', titleKey: 'iep.why.title', introKey: 'iep.why.intro',
        cards: [
          { titleKey: 'iep.why.c1.t', descKey: 'iep.why.c1.d' },
          { titleKey: 'iep.why.c2.t', descKey: 'iep.why.c2.d' },
          { titleKey: 'iep.why.c3.t', descKey: 'iep.why.c3.d' },
          { titleKey: 'iep.why.c4.t', descKey: 'iep.why.c4.d' },
        ],
      },
    ],
    cases: {
